...
def make_target_data_loader(config):
    ...
    train_set = spacenet.Spacenet(city=config.target, split='train', img_root=config.img_root)
    val_set = spacenet.Spacenet(city=config.target, split='val', img_root=config.img_root)
    #test_set = spacenet.Spacenet(city=config.dataset, split='test', img_root=config.img_root)
