...
from utils.loss import SegmentationLosses, MinimizeEntropyLoss, BottleneckLoss
from utils.lr_scheduler import LR_Scheduler
from utils.metrics import Evaluator
from utils.func import bce_loss, prob_2_entropy
import json
import visdom
import torch
...
class Trainer(object):
    ...
    def training(self, epoch):
        ...
        for i, sample in enumerate(tbar):
            ...
            bottleneck_loss = self.bottleneck_loss.loss(A_feat, B_feat) + self.bottleneck_loss.loss(A_low_feat, B_low_feat)
