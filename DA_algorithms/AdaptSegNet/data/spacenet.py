...
class Spacenet(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.split == 'train':
            return self.transform_tr(sample)['image'], self.transform_tr(sample)['label']
        elif self.split == 'val':
            return self.transform_val(sample)['image'], self.transform_tr(sample)['label']
        elif self.split == 'test':
            return self.transform_ts(sample)['image'], self.transform_tr(sample)['label']
